...
# EXTRACT FEATURES FROM COMPLETELY FORGED BLOCKS
SOURCE = 'Datasets/DB'
TEMP_STORAGE = 'Temp/'

option = 8
if option == 0:
    FORGED_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/mf/Forged/'
    ORIGINAL_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/mf/Original/'
    tamper_type = "mf"
elif option == 1:
    FORGED_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/avg/Forged/'
    ORIGINAL_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/avg/Original/'
    tamper_type = "avg"
elif option == 2:
    FORGED_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/gau/Forged/'
    ORIGINAL_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/gau/Original/'
    tamper_type = "gau"
elif option == 3:
    FORGED_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/wnr/Forged/'
    ORIGINAL_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/wnr/Original/'
    tamper_type = "wnr"
elif option == 4:
    FORGED_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/ce/Forged/'
    ORIGINAL_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/ce/Original/'
    tamper_type = "ce"
elif option == 5:
    FORGED_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/res/Forged/'
    ORIGINAL_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/res/Original/'
    tamper_type = "res"
elif option == 6:
    FORGED_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/awgn/Forged/'
    ORIGINAL_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/awgn/Original/'
    tamper_type = "awgn"
elif option == 7:
    FORGED_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/um/Forged/'
    ORIGINAL_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/um/Original/'
    tamper_type = "um"

elif option == 8:
    FORGED_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/jpg/Forged/'
    ORIGINAL_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/jpg/Original/'
    tamper_type = "jpg"

elif option == 9:
    FORGED_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/jp2/Forged/'
    ORIGINAL_FOLDER = 'Training Dataset/PB_DB/Completely_Forged/JPG_70/jp2/Original/'
    tamper_type = "jp2"
...
df_read_forged = pd.read_csv("trainingdataset_64_jpg_forged_70_cf.csv")
...
for file in files:
    ...
    df.to_csv('trainingdataset_64_'+ tamper_type + '_forged_70_cf_1.csv', index=False)
